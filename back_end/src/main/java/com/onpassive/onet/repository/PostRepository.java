...
public interface PostRepository extends CrudRepository<Post,Integer>{
	...
	@Query("select new com.onpassive.onet.model.PostDetails(p.postId,p.fileName,p.description,p.format,u.firstName,u.lastName,u.fileName) from Post p, User u where p.createdBy= u.empId and p.postId=:postId ")
